...
# ბაზაში აღწერილია 5 დღის ამინდის პროგნოზი თბილისისთვის 3 საათიანი ინტერვალებით
...
print("წნევა თბილისში:", res['list'][0]['main']['pressure'], "  დრო და თარიღი:", res['list'][0]['dt_txt'])
print("ქარის სიჩქარეა: ", res['list'][0]['wind']['speed'])
print("მდებარეობა ზღვის დონიდან: ", res['list'][0]['main']['sea_level'])
